...
namespace ConsoleClient
{
    public partial class Client
    {
        ...
        public void Init()
        {
            ...
            PCInfoReader pCInfo = new PCInfoReader();
            while (true)
            {
                WriteNode("ns=2;s=Demo.Memory.Available", pCInfo.ReadRam());
                WriteNode("ns=2;s=Demo.Processor.Count", pCInfo.GetProcessorCount());
                WriteNode("ns=2;s=Demo.Processor.Utilization", pCInfo.ReadCPU());
