...
using ReadClient.Data;
using ConsoleClient;
using UnifiedAutomation.UaBase;
using UnifiedAutomation.UaSchema;
using ConsoleClient.Configuration;
using UnifiedAutomation.UaClient;
using ReadClient.WinUI;

namespace ReadClient
{
    public static class MauiProgram
    {
        public static Client clienteOPC;
        ...
        validationErrors = e.ValidationError.Flattened;
            ...
            static IConfiguration LoadInMemoryConfiguration()
            {
    ...
    new UnifiedAutomation.UaSchema.ModuleTraceSettings() { ModuleName = "UnifiedAutomation.Client" }
            ...
            {
                // Add license.
                ApplicationLicenseManager.AddProcessLicenses(PlatformUtils.GetAssembly(typeof(MauiProgram)), "License.lic");
